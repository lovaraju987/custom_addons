...
class ChannelExtend(models.Model):
    ...
    def _notify_get_recipients(self, message, msg_vals, **kwargs):
        ...
        message_type = msg_vals.get('message_type', 'wa_msgs') if msg_vals else message.message_type
        if not recipients and message_type == 'wa_msgs':
            recipients_data = []
            if self.is_chat or self.channel_type == "chat":
